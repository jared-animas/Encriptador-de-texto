...
copiar.addEventListener("click", () => { // boton para copiar texto
    TextoSalida.select(); // el método select es utilizado para seleccionar el contenido de un campo de texto
    let exito = document.execCommand("copy");    // el método document.execCommand("copy") copia el texto seleccionado al portapapeles
});
